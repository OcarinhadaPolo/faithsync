<nav class="bg-white border-gold-bottom">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    <a href="" class="flex items-center space-x-3 rtl:space-x-reverse">
        ...
        <span class="self-center text-2xl  whitespace-nowrap text-custom-black">Faith<span class="self-center text-2xl whitespace-nowrap text-custom-gold">Sync</span></span>
    ...
    <div class="hidden w-full md:block md:w-auto" id="navbar-default">
        <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:justify-center md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white flex-grow">
            <li>
                <a href="#" class="block py-2 px-3 text-custom-golf rounded md:bg-transparent md:text-custom-gold md:p-0  text-custom-gold" aria-current="page">Início</a>
            </li>
            <li>
                <a href="#" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-custom-gold md:p-0 ">Sobre</a>
            </li>
            <li>
                <a href="#" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-custom-gold md:p-0">Doar</a>
            </li>
